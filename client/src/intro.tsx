  ...
  return (
    <div className="intro-container">
      ...
      <p>
        ...
        grandmother, sister, aunty, cousin and friend to many, Mrs Ethel Ulasi, who 
        on 31st October 2025, will have been alive to witness the earth rotate around 
        the sun 80 times. How amazing is that! We are truly grateful to God and our 
        Lord Jesus Christ, for blessing our dear mother with
